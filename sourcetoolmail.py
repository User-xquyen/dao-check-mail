...
def fakeEmail():
  faker = Faker()
  data_kytu = ['', '_', '.']
  so_luong = int(input("\033[1;94mNhập số lượng=> "))
  Domain = input("\033[1;94mNhập domain=> ")
  file_email = input("\033[1;94mNhập tên file=> ")
  n = 0
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "] \033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;95mMail\033[1;97m] =>\033[1;95m " + fake_email)
...
def checkhotmail():
  try:
    hotmail = open(input("\033[1;94mNhập tên file=> ")).readlines()
    hotmail_die = input("\033[1;94mNhập tên file mail die=> ")
    hotmail_live = input("\033[1;94mNhập tên file mail live=> ")
  except:
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print ("\033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;91mLive\033[1;97m] =>\033[1;91m " + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print ("\033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;92mDie\033[1;97m] =>\033[1;92m " + hot_mail + "@hotmail.com")
...
def checkyahoo():
  try:
    n_yahoo = 0
    yahoo = open(input("\033[1;94mNhập tên file=> ")).readlines()
    yahoo_die = input("\033[1;94m\033[1;94mNhập tên file mail die=> ")
    yahoo_live = input("\033[1;94m\033[1;94mNhập tên file mail live=> ")
  except:
    print (" \033[1;91mKhông tìm thấy file !!!")
    process_menu()
  list_yid = []
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print("\033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;92mDie\033[1;97m] =>\033[1;92m " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print("\033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;91mLive\033[1;97m] =>\033[1;91m " + yid + "@yahoo.com")
...
def checkvalid():
  try:
    fileEmail = open(input("\033[1;94mNhập tên file=> ")).readlines()
    valid = input("Nhập tên file mail liên kết=> ")
  except:
    print (" \033[1;91mKhông tìm thấy file !!!")
    process_menu()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print ("\033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;92mLinked\033[1;97m] =>\033[1;92m " + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print ("\033[1;93mXuan𓊗‏\033[1;96mQuyen\033[1;97m[\033[1;91mNot Linked\033[1;97m] =>\033[1;91m " + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
            ...
            \033[1;93m░░█░░ █░░█ █░░█ █░░   \033[1;34m█░▀░█ █▄▄█ ▀█▀ █░░
            \033[1;36m░░▀░░ ▀▀▀▀ ▀▀▀▀ ▀▀▀   \033[1;35m▀░░░▀ ▀░░▀ ▀▀▀ ▀▀▀
              \033[1;35m❯\033[1;36m❯\033[1;31m❯\033[1;34m Tool by : 𝙓𝙪𝙖𝙣 𝙌𝙪𝙮𝙚𝙣 🦋
              \033[1;35m❯\033[1;36m❯\033[1;31m❯\033[1;33m Zalo : 0352468185
              \033[1;35m❯\033[1;36m❯\033[1;31m❯\033[1;32m Facebook : https://www.facebook.com/dv.xuanquyen
"""
...
\033[1;97mNhập vm để hiển thị menu ⏩
...
"""
  ...
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  choice_user = input ('┌─[\033[1;93mTool\033[1;97m]──[\033[1;96mV1.0\033[1;97m]\n├─[\033[1;91mBy\033[1;97m@\033[1;95mQuyền Depzai Vcl\033[1;97m]\n└─>\033[1;95m ')
  if choice_user == 'rm':
    clear()
    fakeEmail()
  if choice_user == 'hc':
  ...
  if choice_user == 'vm':
    ...
    print("""
                ...
                \033[1;31m[-----------------------------]
                      \033[1;36m〘rm〙Random Mail📧⛏️
                      \033[1;32m〘hc〙Check Hotmail🔥
                      \033[1;33m〘yc〙Check Yahoo💜
                      \033[1;34m〘lc〙Check Liên Kết🔗
                      \033[1;93m〘vm〙View Menu🎮
                      \033[1;35m〘ex〙Thoát Tool🚫
                \033[1;31m[-----------------------------]
  
""")
  if choice_user == 'ex':
    clear()
    print("\033[1;95mTool by 𝙓𝙪𝙖𝙣 𝙌𝙪𝙮𝙚𝙣 𖤍 😏 \033[1;91mBạn đã thoát tool✓")
    quit()
  if choice_user != 'rm' or 'hc' or 'yc' or 'lc' or 'vm' or 'ex':
    process_menu()
  if choice_user == '':
    process_menu()
logo() 
